    ...
    return (
        <Box id='course' className='mlay'>
            ...
            <Box className='course_background layout'>
                <Typography className='course_type'>DG Approved Courses</Typography>
                <Box className='c_card_cont'>
                    {
                        c_data.filter((e) => e.c_type === 'dg').map((item) => (
                ...
                <Box className='c_card_cont'>
                    {
                        c_data.filter((e) => e.c_type === 'ot').map((item) => (
                            <Box className='c_card' key={item.id}>
                                ...
                                <Typography className='course_descr'>{item.c_det}</Typography>
                                <button className='c_det_btn'><Link to={item.path} style={{color:'white',textDecoration:'none'}}>View Details</Link></button>
                            </Box>
                        ))
                    }
                </Box>
