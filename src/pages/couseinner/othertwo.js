...
const Othertwo = () => {
            ...
            if (email !== '' && email.includes('@') && email.includes('.')) {
                if (num !== '' && num.length === 10) {
                    if (statee !== '') {
                        ...
                        const payLoad = { name: name, email: email, number: num, cname: 'MBA in Maritime Operations', ctype: 'NON-DG APPROVED COURSES', ustate: statee, createdAt: newDate };
    ...
    return (
        <Box id='innercourse' className='mlay'>
            <Box className='banner'>MBA in Maritime Operations</Box>
            <Box className='layout course_det'>
                ...
                <Typography className='course_name'>MBA in Maritime Operations</Typography>


                <Typography className='c_connn'>The master’s degree with an emphasis on the business of hospitality will equip graduates to enter the field of hospitality and other service based allied industries at managerial or leadership levels.</Typography>
                ...
                <Typography className='c_connn'>The master’s degree with an emphasis on the business of hospitality will equip graduates to enter the field of hospitality and other service based allied industries at managerial or leadership levels.</Typography>
                <Typography className='c_connn'>MBA in Hospitality operations is a 2 Years Program that focusses on skills and competencies required to ascend in the service industry. The same is done through a comprehensive academic blend of general management knowledge with specialized concept & Application based Hospitality knowledge.</Typography>
